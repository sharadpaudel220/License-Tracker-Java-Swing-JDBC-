//To delete the license detail from database
package project;
import java.sql.*;
import java.awt.*;
...
class Remove_License implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            try{
                Conn con = new Conn();
                con.deleteLicense(Integer.parseInt(t.getText()));
